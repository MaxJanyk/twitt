...
function TweetBox() {
    ...
    const handleTweetSubmit = () => {
        ...
        dispatch(
            addTweet({
                ...
                author: {
                    name: 'max',
                    surname: 'badman7755995@gmail.com',
                    username: 'MaxJanyk',
                    avatarUrl:
                        'https://sun9-63.userapi.com/impf/c851124/v851124076/16e1e4/ksqZP6bDq7E.jpg?size=1632x2048&quality=96&sign=671785be6aa5132c56b722083fea5d31&type=album',
                },
            }),
        );
    };
    ...
    return (
        <div className="tweet-box">
            <div className="tweet-box__inner">
                <div className="tweet-box__avatar">
                    <Avatar
                        src={
                            'https://sun9-63.userapi.com/impf/c851124/v851124076/16e1e4/ksqZP6bDq7E.jpg?size=1632x2048&quality=96&sign=671785be6aa5132c56b722083fea5d31&type=album'
                        }
                ...
                <div className="tweet-box__body">
                    <div className="tweet-box__control">
                        <TextareaAutosize
                    ...
                    <div className="tweet-box__footer">
                        <div className="upload-options">
                            <IconButton className="tweet-box__icon-button">
                                <SvgIcon className="tweet-box__svg-icon">
                                    <g>
